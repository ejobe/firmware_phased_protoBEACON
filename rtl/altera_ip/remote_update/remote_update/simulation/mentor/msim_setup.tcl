...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "remote_update"
}
...
ensure_lib                    ./libraries/remote_update_0/   
vmap       remote_update_0    ./libraries/remote_update_0/   
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_remote_update_core.vhd"     -work remote_update_core
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/remote_update_remote_update_0.vhd" -work remote_update_0   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/remote_update.vhd"                                                    
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L remote_update_core -L remote_update_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L remote_update_core -L remote_update_0 -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L arriav $TOP_LEVEL_NAME
}
